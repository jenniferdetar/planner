...
const NAV_ITEMS = [
  ...
  { label: 'CSEA', href: '/csea', color: 'bg-[#00326b] text-[#ffca38] border-[#ffca38]' },
            ...
            {NAV_ITEMS.map((item) => {
              ...
              return (
                <Link
                  key={item.href}
                  href={item.href}
                  className={`text-center text-sm font-bold rounded-lg px-3 py-2 border-2 border-[#0a2f5f] ${item.color} ${
