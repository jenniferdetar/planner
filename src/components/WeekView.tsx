...
function dedupeEvents(events: Array<{ id: string | number; title?: string; text?: string; color?: string; startLabel?: string | null }>): typeof events {
...
export default function WeekView({ userId, selectedDate, onDateChange, calendarBlocks }: WeekViewProps) {
