  ...
  return (
    <div className="gcu-panel">
      ...
      <div className="gcu-progress-section">
        <p className="gcu-subtitle">Grand Canyon University · College of Humanities and Social Sciences · <a href="https://newportal.gcu.edu/#!/dashboard" target="_blank" rel="noreferrer" style={{ color: '#e6c34d' }}>Student Portal</a> · <a href="https://tuitionrequest.lausd.net/tr?req=ZWtiQlJHall6V21rUm5pZWMzUGpmdz09" target="_blank" rel="noreferrer" style={{ color: '#e6c34d' }}>Tuition Reimbursement</a></p>
