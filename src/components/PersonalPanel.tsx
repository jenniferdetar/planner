...
interface PersonalPanelProps {
  ...
  onUpdateBookStatus: (id: string | number, status: string) => Promise<void>
  onDeleteBook: (id: string | number) => Promise<void>
  onImportBooks: (defaults: any[], existing: any[]) => Promise<void>
}

export default function PersonalPanel({ userId, selectedDate, books, onAddBook, onUpdateBookStatus, onDeleteBook, onImportBooks }: PersonalPanelProps) {
  ...
  function handleEntryEdit(entry: any) {
    setEditingEntryId(entry.id)
    setEditingEntryText(entry.entry)
  }

  function handleEntryChange(id: string | number, val: string) {
  ...
  function handleMantraChange(val: string) {
    setMantra(val)
