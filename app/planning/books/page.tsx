                  ...
                  <tr key={index} className="group hover:bg-[#f8fafc] transition-colors">
                    <td className="p-3 pl-6">
                      <div className="flex items-center gap-4">
                        <div className="w-10 h-10 rounded-2xl bg-gray-50 flex items-center justify-center text-gray-300 group-hover:bg-white group-hover:text-[#0a2f5f] transition-all shadow-inner border border-transparent group-hover:border-gray-100">
                          <BookText size={20} />
                        </div>
                        <input 
                          type="text" 
                          ...
                          className="w-full bg-transparent border-none focus:ring-0 font-black text-[#0a2f5f] placeholder:text-gray-100 text-sm"
                        />
                      </div>
                    </td>
                    <td className="p-3">
                      <input 
                        ...
                        className="w-full bg-transparent border-none focus:ring-0 font-bold text-gray-500 placeholder:text-gray-100 text-sm"
                      />
                    </td>
                    <td className="p-3">
                    ...
                    <td className="p-3 pr-6 text-right">
                      <button 
                        ...
                        className="p-2 text-gray-100 hover:text-red-500 hover:bg-red-50 rounded-2xl transition-all opacity-0 group-hover:opacity-100"
                        title="Remove Entry"
                      >
                        <Trash2 size={18} />
                      </button>
