  ...
  return (
    <div className="p-4 md:p-8 max-w-5xl mx-auto bg-[#fdfbf7] min-h-screen">
      ...
      <section className="relative group mb-16">
        ...
        <div className="relative bg-white p-10 md:p-16 rounded-[3rem] border-2 border-[#0a2f5f]/5 shadow-2xl overflow-hidden">
          {/* Decorative Corner */}
          ...
          {loading ? (
            ...
            <div className="relative">
              <textarea 
                ...
                className="w-full min-h-[450px] p-10 bg-[#fdfbf7] border-2 border-[#e6e2d3] rounded-3xl text-2xl font-serif leading-[3.5rem] focus:ring-4 focus:ring-[#0a2f5f]/5 outline-none transition-all shadow-inner"
                style={{ 
